...
```bash
for i in 50000 75000 100000 150000; do bsub  -J ${i} -n 1 -o %J.${index}.out -e %J.${index}.err -R span[hosts=1] python  ../converse_boundary3.py Block/D5_A2_collinearitEnd.txt  TAD/D5_TAD.txt  TAD/A2_TAD.txt test/D5_A2_${i}_conserve.txt ${i} >test/D5_A2_${i}.err; bsub  -J ${i} -n 1 -o %J.${index}.out -e %J.${index}.err -R span[hosts=1] python ../converse_boundary3.py Block/D5_K12_collinearityEnd.txt  TAD/D5_TAD.txt  TAD/K12_TAD.txt test/D5_K12_${i}_conserve.txt ${i} >test/D5_K12_${i}.err; bsub  -J ${i} -n 1 -o %J.${index}.out -e %J.${index}.err -R span[hosts=1] python ../converse_boundary3.py Block/A2_K12_collinearitEnd.txt  TAD/A2_TAD.txt TAD/K12_TAD.txt test/A2_K12_${i}_conserve.txt ${i} >test/A2_K12_${i}.err; sleep 5; done
```
