...
awk '($2!=0&&$4!=0&&$2/$4<2&&$2/$4>0.5){if($6>0&&$8==0){ printf "A2/D5\t"$4/$2"\t"$1"\tclass2\nAt/Dt\t"0.1/$6"\t"$1"\tclass2\n"}else if($8>0&&$6>0&&$8/$6<=0.5){printf "A2/D5\t"$4/$2"\t"$1"\tclass2\nAt/Dt\t"$8/$6"\t"$1"\tclass2\n"}}$2==0&&$4==0{if($6>0&&$8==0){ printf "A2/D5\t""1\t"$1"\tclass2\nAt/Dt\t"0.1/$6"\t"$1"\tclass2\n"}else if($8>0&&$6>0&&$8/$6<=0.5){printf "A2/D5\t""1\t"$1"\tclass2\nAt/Dt\t"$8/$6"\t"$1"\tclass2\n"}}' leaf_isform_count >>ggplot_data/isform_count.2txt
## 第三类
awk '($6!=0&&$8!=0&&$6/$8<2&&$6/$8>0.5){if($4>0&&$2==0){ printf "A2/D5\t"$4/0.1"\t"$1"\tclass3\nAt/Dt\t"$8/$6"\t"$1"\tclass3\n"}else if($4>0&&$2>0&&$4/$2>=2){printf "A2/D5\t"$4/$2"\t"$1"\tclass3\nAt/Dt\t"$8/$6"\t"$1"\tclass3\n"}}$6==0&&$8==0{if($4>0&&$2==0){ printf "A2/D5\t"$4/0.1"\t"$1"\tclass3\nAt/Dt\t""1\t"$1"\tclass3\n"}else if($4>0&&$2>0&&$4/$2>=2){printf "A2/D5\t"$4/$2"\t"$1"\tclass3\nAt/Dt\t""1\t"$1"\tclass3\n"}}' leaf_isform_count >>ggplot_data/isform_count.2txt
awk '($6!=0&&$8!=0&&$6/$8<2&&$6/$8>0.5){if($2>0&&$4==0){ printf "A2/D5\t"0.1/$2"\t"$1"\tclass3\nAt/Dt\t"$8/$6"\t"$1"\tclass3\n"}else if($4>0&&$2>0&&$2/$4>=2){printf "A2/D5\t"$4/$2"\t"$1"\tclass3\nAt/Dt\t"$8/$6"\t"$1"\tclass3\n"}}$6==0&&$8==0{if($2>0&&$4==0){ printf "A2/D5\t"0.1/$2"\t"$1"\tclass3\nAt/Dt\t""1\t"$1"\tclass3\n"}else if($4>0&&$2>0&&$2/$4>=2){printf "A2/D5\t"$4/$2"\t"$1"\tclass3\nAt/Dt\t""1\t"$1"\tclass3\n"}}' leaf_isform_count >>ggplot_data/isform_count.2txt
## 第四类
 awk '($4>0&&$2==0){if($8>0&&$6==0){ printf "A2/D5\t"$4/0.1"\t"$1"\tclass4\nAt/Dt\t"$8/0.1"\t"$1"\tclass4\n"}else if($8>0&&$6>0&&$8/$6>=2){printf "A2/D5\t"$4/0.1"\t"$1"\tclass4\nAt/Dt\t"$8/$6"\t"$1"\tclass4\n"}}$4>0&&$2>0&&$4/$2>=2{if($8>0&&$6==0){ printf "A2/D5\t"$4/$2"\t"$1"\tclass4\nAt/Dt\t"$8/0.1"\t"$1"\tclass4\n"}else if($8>0&&$6>0&&$8/$6>=2){printf "A2/D5\t"$4/$2"\t"$1"\tclass4\nAt/Dt\t"$8/$6"\t"$1"\tclass4\n"}}' leaf_isform_count >>ggplot_data/isform_count.2txt
 awk '($2>0&&$4==0){if($6>0&&$8==0){ printf "A2/D5\t"0.1/$2"\t"$1"\tclass4\nAt/Dt\t"0.1/$6"\t"$1"\tclass4\n"}else if($8>0&&$6>0&&$6/$8>=2){printf "A2/D5\t"0.1/$2"\t"$1"\tclass4\nAt/Dt\t"$8/$6"\t"$1"\tclass4\n"}}$2>0&&$4>0&&$2/$4>=2{if($6>0&&$8==0){ printf "A2/D5\t"$4/$2"\t"$1"\tclass4\nAt/Dt\t"0.1/$6"\t"$1"\tclass4\n"}else if($8>0&&$6>0&&$6/$8>=2){printf "A2/D5\t"$4/$2"\t"$1"\tclass4\nAt/Dt\t"$8/$6"\t"$1"\tclass4\n"}}' leaf_isform_count   >>ggplot_data/isform_count.2txt
